...
export function Theme() {
  return (
    <section id="theme" className="relative py-24 md:py-32 bg-gradient-soft">
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-2xl">
          <div className="text-xs uppercase tracking-[0.22em] text-wine">Theme</div>
          <h2 className="font-display text-4xl md:text-5xl mt-3">
            Where <span className="text-gradient">{CONVENTION.localTheme}</span> meets{" "}
            <span className="text-gradient">{CONVENTION.nationalTheme}</span>
          </h2>
        </div>

        <div className="grid md:grid-cols-2 gap-6 mt-12">
          <article className="rounded-3xl border border-border bg-card p-8 shadow-soft">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-wine/10 text-wine">
              <Clock className="h-6 w-6" />
            </div>
            <h3 className="font-display text-2xl mt-5">TIME · Local Theme</h3>
          ...
          <article className="rounded-3xl border border-border bg-card p-8 shadow-soft">
            ...
            <h3 className="font-display text-2xl mt-5">Amplify · National Direction</h3>
            <p className="mt-3 text-muted-foreground leading-relaxed">
